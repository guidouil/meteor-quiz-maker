...
Schemas.Questions = new SimpleSchema({
  ...
  'answers.$.correct': {
    type: Boolean,
    label: "C'est la bonne réponse"
  },
  answerTitle: {
    type: String,
    optional: true,
    label: "Titre de l'explication de la bonne réponse"
  },
  answerText: {
    type: String,
    optional: true,
    label: "Texte de l'explication de la bonne réponse",
    autoform: {
      rows: 5
    }
  },
  answerImage: {
    ...
    optional: true,
    regEx: SimpleSchema.RegEx.Url,
    label: "URL de l'image d'explication de la bonne réponse",
    autoform: {
      afFieldInput: {
        type: 'url'
      }
