...
Schemas.Quizzes = new SimpleSchema({
  ...
  closing: {
    type: String,
    optional: true,
    label: "Contenu HTML inclus sous la page d'accuei et de résultats quand le quiz est terminé - #closing",
    autoform: {
      rows: 5
    }
  },
  winners: {
    type: String,
    optional: true,
    label: "Contenu HTML inclus sous la home du quiz si contribué - #winners",
    autoform: {
      rows: 5
    }
  },
  rules: {
    type: String,
    optional: true,
    label: "Contenu HTML du réglement du quiz - #rules",
    autoform: {
      rows: 5
    }
  },
