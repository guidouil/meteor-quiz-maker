...
if (Meteor.isClient) {
  Router.onBeforeAction(function() {
    if (! Meteor.userId()) { // not login
      if (_.contains( ['bo', 'users', 'quizzesList', 'quizInsert', 'quizAdmin', 'quizUpdate', 'questionsList', 'questionInsert', 'questionUpdate', 'answersList'], this.route.getName() )) {
        this.render('login');
      } else {
        this.next();
      }
